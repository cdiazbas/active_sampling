...
# Plot results
zoom = 1.2
fig2, ax = plt.subplots(3,1,figsize=(5*zoom,14/4*2.5*zoom),sharex=True)
ax[0].plot(range(2,n_points+1)[1:],amp_array_gen[1:],'.',label='uniform scheme',color='C0',ms=8)
ax[0].plot(range(2,n_points+1)[1:],amp_array_gen[1:],'-',color='C0',alpha=0.5)
ax[0].plot(range(2,n_points+1)[1:],amp_array_gen2[1:],'.',label='our scheme',color='C1',ms=8)
ax[0].plot(range(2,n_points+1)[1:],amp_array_gen2[1:],'-',label='',color='C1',alpha=0.5)
ax[0].legend()
ax[0].locator_params(axis='y', nbins=6)
ax[0].set_ylabel('STD amplitude [real - fit]')
ax[0].minorticks_on()

ax[1].plot(range(2,n_points+1)[1:],vel_array_gen[1:],'.',label='uniform scheme',color='C0',ms=8)
ax[1].plot(range(2,n_points+1)[1:],vel_array_gen[1:],'-',label='',color='C0',alpha=0.5)
ax[1].plot(range(2,n_points+1)[1:],vel_array_gen2[1:],'.',label='our scheme',color='C1',ms=8)
ax[1].plot(range(2,n_points+1)[1:],vel_array_gen2[1:],'-',label='',color='C1',alpha=0.5)
ax[1].locator_params(axis='y', nbins=6)
ax[1].set_ylabel('STD center [real - fit]')
ax[1].minorticks_on()

ax[2].plot(range(2,n_points+1)[1:],wid_array_gen[1:],'.',label='uniform scheme',color='C0',ms=8)
ax[2].plot(range(2,n_points+1)[1:],wid_array_gen[1:],'-',label='',alpha=0.5,color='C0')
ax[2].plot(range(2,n_points+1)[1:],wid_array_gen2[1:],'.',label='our scheme',color='C1',ms=8)
ax[2].plot(range(2,n_points+1)[1:],wid_array_gen2[1:],'-',label='',alpha=0.5,color='C1')
